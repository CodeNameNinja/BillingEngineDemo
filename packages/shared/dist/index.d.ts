...
export type BillingWarning = {
    code: 'missing_field' | 'ambiguous_term' | 'inconsistent_amount' | 'unsupported_term' | 'parse_error';
    message: string;
    path?: string;
};
...
export type ReminderSchedule = {
    ...
    reminders: Array<{
        ...
        kind: 'issue_immediately' | 'before_due_3d' | 'on_due' | 'after_due_3d' | 'after_due_7d';
    }>;
};
