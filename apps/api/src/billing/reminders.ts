import type { ReminderSchedule } from '@demo/shared';
import { addDaysIsoUtc } from '../lib/time.js';

export function buildDefaultReminderSchedule(args: { invoiceId: string; issuedAt: string; dueAt: string }): ReminderSchedule {
  return {
